...
* tests: Add metric.values and metrics.scores for MA kick/logradient IBI
* docs: Update data.R for missing columns
    + data_benthos_MBSS
    + data_mmi_dev
* refactor: document internal functions of metric.values()
* chore: Remove non-ASCII character from data_mmi_dev
...
* docs: Document undocumented argument
    + metric.stats2
* chore: Rebuild data_benthos_MBSS with missing columns so no warnings in 
example
