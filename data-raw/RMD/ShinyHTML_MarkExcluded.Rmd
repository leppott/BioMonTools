...
'Exclude_New'). It is a TRUE/FALSE field in which redundant taxa are marked as 
'TRUE'.
...
The metric calculation function requires the name 'Exclude'


### Additional Notes

WANT TO TRY RUNNING IT WITH TEST DATA?
Click here to download an example input and output file.
