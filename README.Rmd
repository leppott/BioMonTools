...
If the package `devtools` is missing the code below will install it.
...
Vignettes are not installed by default.  If you want the additional documentat
(recommended) then use this version of the code.
